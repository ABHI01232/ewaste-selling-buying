<%@ Page Title="" Language="C#" MasterPageFile="~/ContentHome.master" AutoEventWireup="true" CodeFile="addvendor.aspx.cs" Inherits="addCanteen" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
<h1><u>Add Seller</u></h1>
<table>
...
<td colspan="2" align="center">
    <asp:Button ID="Button1" runat="server" Text="Add Seller" 
